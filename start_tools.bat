...
cls
echo.
echo  Выберите инстут для запуска:
echo.
...
echo  6. Веб-интерфейс (web_interface.py)
echo.
...
cls
python backend/services/monitor_printer.py --host %host% --interval %interval%
echo.
pause
goto menu
...
cls
python backend/services/websocket_listener.py --host %host%
echo.
pause
goto menu
...
cls
if "%gcode%"=="" (
    python backend/services/send_gcode.py --host %host%
) else (
    python backend/services/send_gcode.py --host %host% --gcode "%gcode%"
)
echo.
pause
goto menu
...
cls
python backend/services/moonraker_tool.py --host %host%
echo.
pause
goto menu
...
cls
python backend/api/web_interface.py --host %host%
echo.
pause
goto menu
...
powershell -Command "(Get-Content backend/services/test_moonraker_api.py) -replace '192\.168\.10\.14', '%new_ip%' | Set-Content backend/services/test_moonraker_api.py"
powershell -Command "(Get-Content backend/services/monitor_printer.py) -replace '192\.168\.10\.14', '%new_ip%' | Set-Content backend/services/monitor_printer.py"
powershell -Command "(Get-Content backend/services/websocket_listener.py) -replace '192\.168\.10\.14', '%new_ip%' | Set-Content backend/services/websocket_listener.py"
powershell -Command "(Get-Content backend/services/send_gcode.py) -replace '192\.168\.10\.14', '%new_ip%' | Set-Content backend/services/send_gcode.py"
powershell -Command "(Get-Content backend/services/moonraker_tool.py) -replace '192\.168\.10\.14', '%new_ip%' | Set-Content backend/services/moonraker_tool.py"
powershell -Command "(Get-Content backend/api/web_interface.py) -replace '192\.168\.10\.14', '%new_ip%' | Set-Content backend/api/web_interface.py"
